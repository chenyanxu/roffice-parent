 ...
 * @version 1.0.0
 */
Ext.define('kalix.roffice.deploy.controller.DeployGridController', {
    extend: 'Ext.app.ViewController',
    requires: [
        'kalix.core.Notify',
        'kalix.roffice.deploy.view.DeployForm',
        'kalix.roffice.deploy.viewModel.DeployViewModel'
    ],
    alias: 'controller.deployGridController',
    /**
     * 查看操作.
     */
    onView: function (target, event) {
        ...
        if (selModel.hasSelection()) {
            var view = Ext.create('kalix.roffice.deploy.view.DeployViewForm');
                ...
                if (button == "yes") {
                    Ext.Ajax.request({
                        ...
                        success: function (response, opts) {
                            ...
                            if (res.success) {
                                kalix.getApplication().getStore('deployStore').reload();
