 ...
 * @version 1.0.0
 */
Ext.define('kalix.roffice.purchaseinvoice.controller.PurchaseInvoiceGridController', {
    extend: 'Ext.app.ViewController',
    requires: [
        'kalix.core.Notify',
        'kalix.roffice.purchaseinvoice.view.PurchaseInvoiceForm',
        'kalix.roffice.purchaseinvoice.viewModel.PurchaseInvoiceViewModel'
    ],
    alias: 'controller.purchaseinvoiceGridController',
    /**
     * 查看操作.
     */
    onView: function (target, event) {
        ...
        if (selModel.hasSelection()) {
            var view = Ext.create('kalix.roffice.purchaseinvoice.view.PurchaseInvoiceViewForm');
                ...
                if (button == "yes") {
                    Ext.Ajax.request({
                        ...
                        success: function (response, opts) {
                            ...
                            if (res.success) {
                                kalix.getApplication().getStore('purchaseinvoiceStore').reload();
