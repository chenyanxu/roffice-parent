...
public class InitActivator implements BundleActivator {
    ...
    public static final String KALIX_APP_ROFFICE_PATH = "/kalix/app/roffice/receive";
    public static final String KALIX_ROFFICE_RESOURCES_IMAGES = "/kalix/roffice/receive/resources/images";
    ...
    public void start(BundleContext bundleContext) throws Exception {
        ...
        httpService.registerResources(KALIX_APP_ROFFICE_PATH, "/roffice/receive", null);
