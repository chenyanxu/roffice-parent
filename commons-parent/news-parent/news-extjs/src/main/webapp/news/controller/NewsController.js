 ...
 * @version 1.0.0
 */
Ext.define('Kalix.news.controller.NewsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.newsController',
    requires: [
        'Kalix.view.components.common.PagingToolBar',
        'Kalix.news.view.NewsGrid',
    ...
    onInitDataGrid: function () {
        var newsStore = Ext.create('Kalix.news.store.NewsStore');
        var dataGird = Ext.create("Kalix.news.view.NewsGrid",
            {
                store: newsStore,
                bbar: [{
